...
var addToCard = document.querySelectorAll('.add-to-card');
var cardCounter = document.querySelector('#cardCounter');

function updatecard(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/update-card', pizza).then(function (res) {
...
__webpack_require__(/*! /media/duggal/f6c93e0f-a886-4d08-a6a1-793d81deb52b/karan/programming/files/Node/project/06.project/realTimePizza/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /media/duggal/f6c93e0f-a886-4d08-a6a1-793d81deb52b/karan/programming/files/Node/project/06.project/realTimePizza/resources/scss/app.scss */"./resources/scss/app.scss");
